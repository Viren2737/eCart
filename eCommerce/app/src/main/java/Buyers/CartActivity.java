    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter =
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                oneTypeProductPrice = Integer.valueOf(model.getQuantity())*Integer.valueOf(model.getPrice());
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists())
                {
                    ...
                    if(shippingState.equals("shipped"))
                    {
                        ...
                        txtMsg1.setText("Congratulations, your final order has been Shipped successfully.You will soon receive your order at your doorstep");
