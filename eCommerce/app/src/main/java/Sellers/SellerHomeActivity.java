...
//                    Toast.makeText(SellerHomeActivity.this, "Home", Toast.LENGTH_LONG).show();
//                }
//                else if (destination.getId() == R.id.navigation_add) {
//                    Toast.makeText(SellerHomeActivity.this, "Add product", Toast.LENGTH_LONG).show();
//                }
//                else if (destination.getId() == R.id.navigation_logout) {
//                    Toast.makeText(SellerHomeActivity.this, "Logout", Toast.LENGTH_LONG).show();
        ...
        unverifiedProductsRef.child(productID)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(SellerHomeActivity.this, "That item has been deleted successfullu", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
